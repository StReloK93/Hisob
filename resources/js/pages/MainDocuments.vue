...
import AddDocument from '@/components/MainDocument/AddDocument.vue'
import EditDocument from '@/components/MainDocument/EditDocument.vue'
...
const columnDefs = reactive([
    ...
    { field: "description", headerName: "Izoh" },
    {
