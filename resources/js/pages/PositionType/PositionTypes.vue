...
import AddPositionType from './components/AddPositionType.vue'
import EditPositionType from './components/EditPositionType.vue'
...
const columnDefs = reactive([
    ...
    { field: "code", headerName: 'T/R', width: 80 },
